...
% あの本を読みなおしてまとめる！ 
% 1. ガウス過程回帰の概要説明。メリットデメリットも。
% 2. 多次元ガウス分布の説明。平均、共分散行列など。
% 3. P63付近、線形回帰からガウス過程までの導出。カーネルの説明。P81の事前に得られたデータDが...を最初に持ってくる。予測分布。
% 4. カーネルの補足説明。事前知識を反映できる。
...
新しい観測点$\boldsymbol{X}^*$における出力$\boldsymbol{y}^*$の周辺分布$p(\boldsymbol{y}^*|\boldsymbol{X}^*, \mathcal{D})$
